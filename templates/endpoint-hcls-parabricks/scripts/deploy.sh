...
HCLS_IMAGE="${HCLS_IMAGE:-cr.eu-north1.nebius.cloud/e00jz93pkqx2m4vqj4/hcls/parabricks-deepvariant-api:20260908-dynamic-v3}"
PARABRICKS_VERSION="${PARABRICKS_VERSION:-latest}"
...
CREATE_CMD=(nebius ai endpoint create
  ...
  --name "${ENDPOINT_NAME:-hcls-parabricks-rest-mcp}"
  --image "$HCLS_IMAGE"
  --container-port 8000
  ...
  --env "PARABRICKS_VERSION=$PARABRICKS_VERSION"
