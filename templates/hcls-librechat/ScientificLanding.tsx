...
const workflows = [
  {
    ...
    prompt: 'Help me tackle the AI infrastructure challenge at the Stockholm Longevity × AI Hackathon. Show what you can do with your installed nebius-cloud-basics, nebius-capacity-quotas, nebius-compute-provision, nebius-serverless-jobs and nebius-serverless-endpoints skills. Ask which workload I want to build, then use Tavily to check the relevant official documentation and discover the hosted scientific models I can already use here. Load the relevant Nebius skills and prepare a concrete GPU/CPU choice, job or endpoint configuration, a small benchmark and a cost-estimation method. Use nebius-infrastructure-prep for a handoff to my own coding environment, including the official MCP setup guide at https://github.com/nebius/mcp-server/blob/main/AGENT_SETUP.md and SAFE_MODE=true. Explain what these installed skills can prepare here and what needs my own cloud connection. Do not ask for credentials or create cloud resources.',
  },
  {
