...
Prüfliste: 3 strittige Einträge stehen in review.md, nicht im Brieftext. Auch korrekte Angaben können dort stehen; Vollständigkeit prüfen.
...
- Die Beschwerden treten auch abends beim Einschlafen auf und sind mit einer allgemeinen Unruhe verbunden. [F0003]
- Der Patient hat familiäre Vorgeschichte eines Großvaters mit drei Herzinfarkten, der daran verstorben ist. [F0004]
- Der Patient hatte vor einigen Jahren eine depressive Episode mit bekanntem psychosozialen Auslöser (Trennung), die behandelt wurde und vollständig abgeklungen ist. [F0005]
- Aktuell fühlt sich der Patient emotional seltsam, gereizt und hat eine verminderte Stressresistenz, was sich anders anfühlt als die frühere Depression. [F0006]
- Der Patient leidet unter starkem nächtlichem Schwitzen, sodass das T-Shirt morgens ausgewrungen werden könnte. [F0008]
- Trotz gesteigerten Appetits hat der Patient in den letzten sechs Wochen vier Kilogramm abgenommen. [F0010]

## Vorgeschichte, Medikation und Allergien

- Der Patient studiert Maschinenbau und befindet sich aktuell in der Prüfungsphase. [F0011]
- Der Patient verdient zusätzlich durch Tätigkeiten wie Autowerkstatt oder Fahrradreparatur, die er als entspannend empfindet. [F0012]
- Die Beziehung des Patienten zur Freundin läuft gut, die Sexualität ist unauffällig. [F0013]

## Befunde

- Der Patient schildert plötzlich einsetzende Beschwerden vor sechs Wochen ohne klaren Lebensereignis-Bezug, bei ansonsten stabiler sozialer und beruflicher Situation. [F0014]

## Dokumentierte Beurteilung

- Die Symptome (Herzrasen, Gewichtsabnahme bei gutem Appetit, Schlafstörungen, nächtliches Schwitzen, innere Unruhe, emotionale Veränderungen) sprechen für eine mögliche Schilddrüsenüberfunktion. [F0015]

## Dokumentiertes Vorgehen

- Es ist eine körperliche Untersuchung geplant, insbesondere mit Fokus auf das Herz. [F0017]
- Es soll Blut abgenommen werden, um die Schilddrüsenfunktion zu überprüfen. [F0018]
- Der Patient soll bis zum nächsten Termin überlegen, ob ihm weitere Beschwerden oder Veränderungen einfallen. [F0019]
- Die Laborergebnisse sollen in zwei bis drei Tagen besprochen werden, danach erfolgt eine erneute Vorstellung. [F0020]
...
- [F0017] 4624–4731: “Untersuchung sehen. Wenn Sie damit einverstanden, das klingt nach einem Plan. Ja schön, dann bis gleich.”
