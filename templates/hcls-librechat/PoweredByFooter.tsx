...
// Official NVIDIA logo artwork (Wikimedia Commons "NVIDIA logo.svg", 656x120
// published asset, viewBox 0 0 164 30), rendered in the official NVIDIA green
// rgb(118,185,0) — the standard all-green brand usage that stays legible on
// dark surfaces.
function NvidiaLogo() {
  return (
    <svg
