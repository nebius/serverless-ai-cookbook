...
export const JSON_SCHEMAS = Object.freeze({
  ...
  openfold2: { type: "object", additionalProperties: false, required: ["sequence"], properties: { sequence: { type: "string" }, input_id: { type: "string" }, alignments: { type: "object" }, templates: { type: "array" }, selected_models: { type: "array", items: { type: "integer" } }, relax: { type: "boolean" } } },
